...
namespace SPLibrary.ProjectManagement.VO
{
	[DataContract]
	[Serializable]
    public partial class AllBusinessAverageScoreViewVO :CommonVO, ICommonVO,ICloneable
    {
    	readonly static List<string> _propertyList = VOHelper.GetVOPropertyList(typeof(AllBusinessAverageScoreViewVO));
        ...
        {
            AllBusinessAverageScoreViewVO tmp = new AllBusinessAverageScoreViewVO();
