...
namespace SPLibrary.ProjectManagement.VO
{
    [DataContract]
    [Serializable]
    public partial class CommissionDelegationVO : CommonVO, ICommonVO, ICloneable
    {
        readonly static List<string> _propertyList = VOHelper.GetVOPropertyList(typeof(CommissionDelegationVO));
        ...
        {
            CommissionDelegationVO tmp = new CommissionDelegationVO();
