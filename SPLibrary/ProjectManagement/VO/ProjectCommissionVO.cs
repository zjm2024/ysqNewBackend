...
namespace SPLibrary.ProjectManagement.VO
{
    [DataContract]
    [Serializable]
    public partial class ProjectCommissionVO : CommonVO, ICommonVO, ICloneable
    {
        readonly static List<string> _propertyList = VOHelper.GetVOPropertyList(typeof(ProjectCommissionVO));
        ...
        {
            ProjectCommissionVO tmp = new ProjectCommissionVO();
