...
namespace SPLibrary.RequireManagement.VO
{
    [DataContract]
    [Serializable]
    public partial class TenderInfoRequirementViewVO : CommonVO, ICommonVO, ICloneable
    {
        readonly static List<string> _propertyList = VOHelper.GetVOPropertyList(typeof(TenderInfoRequirementViewVO));
        ...
        [DataMember]
        public Int32 TenderCustomerId { get { return (Int32)GetValue(typeof(Int32), "TenderCustomerId"); } set { SetValue("TenderCustomerId", value); } }
        [DataMember]
        ...
        {
            TenderInfoRequirementViewVO tmp = new TenderInfoRequirementViewVO();
