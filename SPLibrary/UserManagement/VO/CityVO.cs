...
namespace SPLibrary.UserManagement.VO
{
	[DataContract]
	[Serializable]
    public partial class CityVO :CommonVO, ICommonVO,ICloneable
    {
    	readonly static List<string> _propertyList = VOHelper.GetVOPropertyList(typeof(CityVO));
