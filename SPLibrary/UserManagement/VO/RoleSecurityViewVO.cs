...
namespace SPLibrary.UserManagement.VO
{
	[DataContract]
	[Serializable]
    public partial class RoleSecurityViewVO :CommonVO, ICommonVO,ICloneable
    {
    	readonly static List<string> _propertyList = VOHelper.GetVOPropertyList(typeof(RoleSecurityViewVO));
        ...
        {
            RoleSecurityViewVO tmp = new RoleSecurityViewVO();
