...
namespace SPLibrary.UserManagement.VO
{
	[DataContract]
	[Serializable]
    public partial class UserSecurityViewVO :CommonVO, ICommonVO,ICloneable
    {
    	readonly static List<string> _propertyList = VOHelper.GetVOPropertyList(typeof(UserSecurityViewVO));
        ...
        {
            UserSecurityViewVO tmp = new UserSecurityViewVO();
