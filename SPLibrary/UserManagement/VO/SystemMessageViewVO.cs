...
namespace SPLibrary.UserManagement.VO
{
	[DataContract]
	[Serializable]
    public partial class SystemMessageViewVO :CommonVO, ICommonVO,ICloneable
    {
    	readonly static List<string> _propertyList = VOHelper.GetVOPropertyList(typeof(SystemMessageViewVO));
        ...
        {
            SystemMessageViewVO tmp = new SystemMessageViewVO();
