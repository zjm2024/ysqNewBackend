...
namespace SPLibrary.UserManagement.DAO
{
    public partial class DepartmentDAO:CommonDAO,IDepartmentDAO
    {
		...
		{
			base._tableName="T_CSC_Department";
