...
{
    public partial class SubscriptionDAO : CommonDAO, ISubscriptionDAO
    {
		public SubscriptionDAO(UserProfile userProfile)
		{
			base._tableName= "t_bc_subscription";
        ...
        public List<SubscriptionVO> FindAllByPageIndex(string conditionStr, string sortcolname, string asc, params object[] parameters)
        {
            string strSQL = "";
        ...
        public List<SubscriptionVO> FindAllByPageIndex(string conditionStr, string sortcolname, string asc,int limit, params object[] parameters)
        {
            string strSQL = "";
