...
{
    public partial class AccessrecordsViewGroupDAO : CommonDAO, IAccessrecordsViewDAO
    {
		public AccessrecordsViewGroupDAO(UserProfile userProfile)
		{
			base._tableName= "v_bcaccessrecordsviewByGroup";
