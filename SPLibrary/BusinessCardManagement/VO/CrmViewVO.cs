...
namespace SPLibrary.BusinessCardManagement.VO
{
	[DataContract]
	[Serializable]
    public partial class CrmViewVO : CommonVO, ICommonVO,ICloneable
    {
    	readonly static List<string> _propertyList = VOHelper.GetVOPropertyList(typeof(CrmViewVO));
        ...
        [DataMember]
        public Int32 isAllApproval { get; set; }

        #region ICloneable Member
        public override object Clone()
        {
            CrmViewVO tmp = new CrmViewVO();
