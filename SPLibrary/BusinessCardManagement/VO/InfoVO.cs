...
namespace SPLibrary.BusinessCardManagement.VO
{
	[DataContract]
	[Serializable]
    public partial class InfoVO : CommonVO, ICommonVO,ICloneable
    {
    	readonly static List<string> _propertyList = VOHelper.GetVOPropertyList(typeof(InfoVO));
        ...
        [DataMember]
        public String JumpAddress { get { return (String)GetValue(typeof(String), "JumpAddress"); } set { SetValue("JumpAddress", value); } }
