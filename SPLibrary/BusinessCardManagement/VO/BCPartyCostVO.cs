...
namespace SPLibrary.BusinessCardManagement.VO
{
    [DataContract]
    [Serializable]
    public partial class BCPartyCostVO : CommonVO, ICommonVO, ICloneable
    {
        readonly static List<string> _propertyList = VOHelper.GetVOPropertyList(typeof(BCPartyCostVO));
        ...
        {
            BCPartyCostVO tmp = new BCPartyCostVO();
    ...
    public class BCWinning
    {
        public BCPartyCostVO PartyCost { get; set; }
        public List<BCPartySignUpVO> PartySignUp { get; set; }
    }

    public class BCCostItem
    {
