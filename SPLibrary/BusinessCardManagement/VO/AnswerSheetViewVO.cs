...
namespace SPLibrary.BusinessCardManagement.VO
{
	[DataContract]
	[Serializable]
    public partial class AnswerSheetViewVO : CommonVO, ICommonVO,ICloneable
    {
    	readonly static List<string> _propertyList = VOHelper.GetVOPropertyList(typeof(AnswerSheetViewVO));
        [DataMember]
        ...
        //[DataMember]
        ////public String answersheet_content { get { return (String)GetValue(typeof(String), "answersheet_content"); } set { SetValue("answersheet_content", value); } }
        ////[DataMember]
        ...
        ////[DataMember]
        ////public String questionnairedata_content { get { return (String)GetValue(typeof(String), "questionnairedata_content"); } set { SetValue("questionnairedata_content", value); } }
        //[DataMember]
        ...
        {
            AnswerSheetViewVO tmp = new AnswerSheetViewVO();
