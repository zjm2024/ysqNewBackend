...
namespace SPLibrary.BusinessCardManagement.VO
{
	[DataContract]
	[Serializable]
    public partial class AccessrecordsViewByRespondentsVO : CommonVO, ICommonVO,ICloneable
    {
    	readonly static List<string> _propertyList = VOHelper.GetVOPropertyList(typeof(AccessrecordsViewByRespondentsVO));
        ...
        {
            AccessrecordsViewByRespondentsVO tmp = new AccessrecordsViewByRespondentsVO();
