...
namespace SPLibrary.BusinessCardManagement.VO
{
	[DataContract]
	[Serializable]
    public partial class ShareVO : CommonVO, ICommonVO,ICloneable
    {
    	readonly static List<string> _propertyList = VOHelper.GetVOPropertyList(typeof(ShareVO));
		[DataMember]
		public Int32 ShareID { get { return (Int32)GetValue(typeof(Int32), "ShareID") ; } set {  SetValue("ShareID", value); } }
        [DataMember]
        ...
        [DataMember]
        public Boolean SendOrReceive { get { return (Boolean)GetValue(typeof(Boolean), "SendOrReceive"); } set { SetValue("SendOrReceive", value); } }
        [DataMember]
