...
{
    public partial class CompanyUPDAO : CommonDAO, ICompanyDAO
    { 
        public CompanyUPDAO(UserProfile userProfile)
		{
			base._tableName= "v_companyview";
        ...
        public List<CompanyVO> FindAllByPageIndex(string conditionStr, int limit, params object[] parameters)
        {
            string strSQL = "";
