...
{
    public partial class CardFormListTempDAO : CommonDAO, ICardFormListTempDAO
    { 
        public CardFormListTempDAO(UserProfile userProfile)
		{
			base._tableName= "t_card_formlist_temp";
