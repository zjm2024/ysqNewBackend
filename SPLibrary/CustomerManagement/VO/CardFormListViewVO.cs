...
namespace SPLibrary.CustomerManagement.VO
{
	[DataContract]
	[Serializable]
    public partial class CardFormListViewVO : CommonVO, ICommonVO,ICloneable
    {
    	readonly static List<string> _propertyList = VOHelper.GetVOPropertyList(typeof(CardFormListViewVO));
        ...
        {
            CardFormListViewVO tmp = new CardFormListViewVO();
