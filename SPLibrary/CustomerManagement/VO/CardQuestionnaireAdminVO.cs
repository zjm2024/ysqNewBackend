...
namespace SPLibrary.CustomerManagement.VO
{
	[DataContract]
	[Serializable]
    public partial class CardQuestionnaireAdminVO : CommonVO, ICommonVO,ICloneable
    {
    	readonly static List<string> _propertyList = VOHelper.GetVOPropertyList(typeof(CardQuestionnaireAdminVO));
        ...
        {
            CardQuestionnaireAdminVO tmp = new CardQuestionnaireAdminVO();
