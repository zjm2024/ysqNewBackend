...
namespace SPLibrary.CustomerManagement.VO
{
	[DataContract]
	[Serializable]
    public partial class CardGroupCardViewVO : CommonVO, ICommonVO,ICloneable
    {
    	readonly static List<string> _propertyList = VOHelper.GetVOPropertyList(typeof(CardGroupCardViewVO));
        ...
        [DataMember]
        public Int32 CardStatus { get { return (Int32)GetValue(typeof(Int32), "CardStatus"); } set { SetValue("CardStatus", value); } }
        [DataMember]
        ...
        {
            CardGroupCardViewVO tmp = new CardGroupCardViewVO();
