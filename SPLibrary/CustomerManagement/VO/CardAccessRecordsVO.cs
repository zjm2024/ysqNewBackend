...
namespace SPLibrary.CustomerManagement.VO
{
	[DataContract]
	[Serializable]
    public partial class CardAccessRecordsVO : CommonVO, ICommonVO,ICloneable
    {
    	readonly static List<string> _propertyList = VOHelper.GetVOPropertyList(typeof(CardAccessRecordsVO));
        ...
        [DataMember]
        public Int32 ShareCustomerId { get { return (Int32)GetValue(typeof(Int32), "ShareCustomerId"); } set { SetValue("ShareCustomerId", value); } }
        [DataMember]
        ...
        {
            CardAccessRecordsVO tmp = new CardAccessRecordsVO();
