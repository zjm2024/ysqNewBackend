...
namespace SPLibrary.CustomerManagement.VO
{
    [DataContract]
    [Serializable]
    public partial class CardOfferDemandViewVO : CommonVO, ICommonVO, ICloneable
    {
        readonly static List<string> _propertyList = VOHelper.GetVOPropertyList(typeof(CardOfferDemandViewVO));
        ...
        [DataMember]
        public Int32 OfferCustomerId { get { return (Int32)GetValue(typeof(Int32), "OfferCustomerId"); } set { SetValue("OfferCustomerId", value); } }
        [DataMember]
        public DateTime OfferCreatedAt { get { return (DateTime)GetValue(typeof(DateTime), "OfferCreatedAt"); } set { SetValue("OfferCreatedAt", value); } }

        #region ICloneable Member
        public override object Clone()
        {
            CardOfferDemandViewVO tmp = new CardOfferDemandViewVO();
