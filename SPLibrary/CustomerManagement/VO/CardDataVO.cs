...
namespace SPLibrary.CustomerManagement.VO
{
	[DataContract]
	[Serializable]
    public partial class CardDataVO : CommonVO, ICommonVO,ICloneable
    {
    	readonly static List<string> _propertyList = VOHelper.GetVOPropertyList(typeof(CardDataVO));
        ...
        [DataMember]
        public Int32 isPublic { get { return (Int32)GetValue(typeof(Int32), "isPublic"); } set { SetValue("isPublic", value); } }
        [DataMember]
        public Int32 isDummy { get { return (Int32)GetValue(typeof(Int32), "isDummy"); } set { SetValue("isDummy", value); } }
        [DataMember]
