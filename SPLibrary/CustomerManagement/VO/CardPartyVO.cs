...
namespace SPLibrary.CustomerManagement.VO
{
	[DataContract]
	[Serializable]
    public partial class CardPartyVO : CommonVO, ICommonVO,ICloneable
    {
    	readonly static List<string> _propertyList = VOHelper.GetVOPropertyList(typeof(CardPartyVO));
        ...
        [DataMember]
        public CardPartyCostVO FirstPrize { get; set; }


        #region ICloneable Member
        public override object Clone()
        {
            CardPartyVO tmp = new CardPartyVO();
