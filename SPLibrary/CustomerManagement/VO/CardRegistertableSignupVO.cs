...
namespace SPLibrary.CustomerManagement.VO
{
	[DataContract]
	[Serializable]
    public partial class CardRegistertableSignupVO : CommonVO, ICommonVO,ICloneable
    {
    	readonly static List<string> _propertyList = VOHelper.GetVOPropertyList(typeof(CardRegistertableSignupVO));
        ...
        {
            CardRegistertableSignupVO tmp = new CardRegistertableSignupVO();
    ...
    public class RegistertableSigupForm
    {
        ...
        public List<UrlLists> UrlList { get; set; }
    }
