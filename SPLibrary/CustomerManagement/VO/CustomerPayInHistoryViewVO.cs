...
namespace SPLibrary.CustomerManagement.VO
{
    [DataContract]
    [Serializable]
    public partial class CustomerPayInHistoryViewVO : CommonVO, ICommonVO, ICloneable
    {
        readonly static List<string> _propertyList = VOHelper.GetVOPropertyList(typeof(CustomerPayInHistoryViewVO));
        ...
        {
            CustomerPayInHistoryViewVO tmp = new CustomerPayInHistoryViewVO();
