...
namespace SPLibrary.CustomerManagement.VO
{
    [DataContract]
    [Serializable]
    public partial class BusinessCategoryViewVO : CommonVO, ICommonVO, ICloneable
    {
        readonly static List<string> _propertyList = VOHelper.GetVOPropertyList(typeof(BusinessCategoryViewVO));

        [DataMember]
        public Int32 BusinessCategoryId { get { return (Int32)GetValue(typeof(Int32), "BusinessCategoryId"); } set { SetValue("BusinessCategoryId", value); } }
        [DataMember]
        ...
        {
            BusinessCategoryViewVO tmp = new BusinessCategoryViewVO();
