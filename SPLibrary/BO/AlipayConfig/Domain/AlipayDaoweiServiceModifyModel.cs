...
namespace Aop.Api.Domain
{
    ...
    public class AlipayDaoweiServiceModifyModel : AopObject
    {
        ...
        /// <summary>
        /// 外部服务id,雇主自己维护的唯一标识,用于确定雇主的某个服务.仅支持数字,字母和下划线
        /// </summary>
        [XmlElement("out_service_id")]
        public string OutServiceId { get; set; }

        /// <summary>
        /// 外部的服务者id：由雇主自己维护的服务者唯一标识,服务者模式必填.仅支持数字,字母和下划线
        /// </summary>
        ...
        /// <summary>
        /// 外部雇主sku属性信息。示例:{"key":"floor","value":[{"out_pv_id":"a1","value":"一楼"},{"out_pv_id":"a2","value":"二楼"}]}表示定义了一个floor的sku属性，该属性有两个值分别为"一楼"和二楼，分别用编号1，2来代替。out_pv_id在每个商品中是唯一的,由雇主定义，用来标示一个sku属性值
        /// </summary>
        [XmlArray("property")]
