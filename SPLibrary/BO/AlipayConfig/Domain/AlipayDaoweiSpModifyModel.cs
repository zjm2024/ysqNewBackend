...
namespace Aop.Api.Domain
{
    ...
    public class AlipayDaoweiSpModifyModel : AopObject
    {
        ...
        /// <summary>
        /// 服务者服务列表信息：包括服务者可提供的类目服务和证书信息等，其中license_id是雇主服务者证照的唯一标识，用于确定雇主的某个服务者的某个证照，仅支持数字、字母和下划线
        /// </summary>
        ...
        /// <summary>
        /// 雇主服务者id，由雇主维护的该雇主下某个服务者的唯一标识，仅支持数字、字母和下划线的组合
        /// </summary>
        [XmlElement("out_sp_id")]
        public string OutSpId { get; set; }

        /// <summary>
        /// 服务者的头像url，只支持https，图片大小限制60K以下。请勿发布涉及黄赌毒以及其他违反国家法律法规的图片，如果有安全问题，将会通知雇主修改后重新同步服务者头像
        /// </summary>
