        ...
        public ResultObject GetDashboardSumUsers(string token)
        {
            ...
            try
            {
                ...
                var outParamObj = new
                {
                    Vip = Vip,
                    VipToday = VipToday,
                    VipYesterday = VipYesterday,
                    VipBeforeYesterday = VipBeforeYesterday,
                    VipYesterdayPercentage = VipYesterdayPercentage,
                    VipLastweek = VipLastweek,
                    VipBeforeLastweek = VipBeforeLastweek,
                    VipLastweekPercentage = VipLastweekPercentage,
                    VipLastmonth = VipLastmonth,
                    VipBeforeLastmonth = VipBeforeLastmonth,
                    VipLastmonthPercentage = VipLastmonthPercentage,
                    VipThismonth = VipThismonth
                };
