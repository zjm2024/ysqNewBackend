...
namespace SPlatformService
{
    ...
    */
    public class WxPayConfig
    {
        ...
        */
        public const string SSLCERT_PATH = "C:/web/ca/1494588702_20240312_cert/apiclient_cert.p12";
        public static string SSLCERT_PASSWORD = ConfigInfo.Instance.PayMCHID;


        //=======【支付结果通知url】===================================== 
        /* 支付结果通知回调url，用于商户接收支付结果
        */
        public const string NOTIFY_URL = "http://www.zhongxiaole.net/Pay/WX_Notify_Url.aspx";

        //=======【商户系统后台机器IP】===================================== 
        /* 此参数可手动配置也可在程序中自动获取
        */
        public const string IP = "121.36.100.221";
