<%@ Page Language="C#" MasterPageFile="~/Shared/MasterPage.Master" AutoEventWireup="true" CodeBehind="ProjectBrowse.aspx.cs" Inherits="SPlatformService.ProjectManagement.ProjectBrowse" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Content" runat="server">    
    <script type="text/javascript" src="../Scripts/ProjectManagement/ProjectBrowseJS.js"></script>
    <%--<div class="search-condition">        
        <table class="wtright" style="height: 100%; float: left;">
            <tr>               
                <td>
                    <button class="wtbtn yjright" type="button" style="display:none" id="btn_new" onclick="return NewProject();" title="新建">
                        <i class="icon-ok bigger-110"></i>
                        新建
                    </button>
                    <button class="wtbtn yjright" type="button" id="btn_delete" style="display:none" onclick="return DeleteProject();" title="删除">
                        <i class="icon-ok bigger-110"></i>
                        删除
                    </button>
                </td>
                ...
                <div class="form-group" style="margin-top: 10px;">       
                    ...
                    <div class="col-sm-2">
                        <asp:DropDownList ID="drpStatus" runat="server" CssClass="col-xs-12 col-sm-12">
                            ...
                            <asp:ListItem Text="已生成" Value="0"></asp:ListItem>
                            <asp:ListItem Text="工作中" Value="1"></asp:ListItem>
                            <%--<asp:ListItem Text="已完成" Value="2"></asp:ListItem>--%>
                            <asp:ListItem Text="申请完工" Value="3"></asp:ListItem>
                            <asp:ListItem Text="申请退款" Value="4"></asp:ListItem>
                            <asp:ListItem Text="退款完成" Value="5"></asp:ListItem>
                        </asp:DropDownList>
                    </div>                
