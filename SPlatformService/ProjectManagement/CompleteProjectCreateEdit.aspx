<%@ Page Language="C#" MasterPageFile="~/Shared/MasterPage.Master" AutoEventWireup="true" CodeBehind="CompleteProjectCreateEdit.aspx.cs" Inherits="SPlatformService.ProjectManagement.CompleteProjectCreateEdit" %>


<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Content" runat="server">
    <script type="text/javascript" src="../Scripts/ProjectManagement/CompleteProjectCreateEditJS.js"></script>   
