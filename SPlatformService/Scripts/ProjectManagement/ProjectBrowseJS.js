...
function onPageInit() {
    ...
    grid.jqGrid.Params = "table=ProjectList&ExcludeStatus=2";
...
function EditProject(projectObj) {
    window.location.href = "ProjectCreateEdit.aspx?ProjectId=" + $(projectObj).prev().val();
    return false;
}

function NewProject() {
    window.location.href = "ProjectCreateEdit.aspx";
    return false;
}
