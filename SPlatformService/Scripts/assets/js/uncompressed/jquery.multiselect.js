  ...
  $.widget("ech.multiselect", {
    ...
    _create: function() {
      ...
      var button = (this.button = $('<button type="button"><span class="ui-icon ui-icon-triangle-1-s"></span></button>'))
        ...
        .addClass(o.classes)
        .attr({ 'title': el.attr('title'), 'tabIndex': el.attr('tabIndex'), 'id': el.attr('id') ? el.attr('id') + '_ms' : null, 'name': (el.attr('id') ? el.attr('id') + '_ms' : null)+"_name" })
    ...
    refresh: function(init) {
      ...
      function makeItem(option, isInOptionGroup) {
        ...
        $("<span/>").text($(option).text()).addClass("ui-multiselect-align-right").appendTo($label);
    ...
    update: function() {
      ...
      if(numChecked === 0) {
        ...
        if($.isFunction(o.selectedText)) {
          ...
          value = $checked.map(function() { return $(this).prev().text(); }).get().join(o.selectedListSeparator);
        } else {
