...
function onPageInit() {
    ...
    grid.jqGrid.Params = "table=CarouselList";
    grid.jqGrid.LengthMenu = ["20", "50", "100", "150"];
    grid.jqGrid.DefaultSortCol = "CreatedAt";
    grid.jqGrid.DefaultSort = "desc";
    grid.jqGrid.Multiselect = true;
    grid.jqGrid.AddColumn("CarouselID", "操作", false, "center", 50,
    ...
    grid.jqGrid.AddHidColumn("CarouselID");
    grid.jqGrid.AddColumn("Text", "内容", true, null, 100);
...
function EditSuggestion(suggestionObj) {
    window.location.href = "CarouselCreateEdit.aspx?CarouselID=" + $(suggestionObj).prev().val();
    return false;
}

function NewSuggestion() {
    window.location.href = "CarouselCreateEdit.aspx";
    return false;
}
...
function DeleteAction(suggestionId) {
    var url = _RootPath + "SPWebAPI/User/DeleteCarousel?CarouselID=" + suggestionId + "&token=" + _Token;
