...
function onPageInit() {
    ...
    gridBusiness.jqGrid.AddColumn("Status", "资料认证状态", true, null, 50,
        function (obj, options, rowObject) {
            if (obj == '0')
                return "申请认证";
            else if (obj == '1')
    ...
    gridBusiness.jqGrid.AddColumn("RealNameStatus", "实名认证状态", true, null, 50,
        function (obj, options, rowObject) {
            if (obj == '0')
                return "未认证";
            else if (obj == '1')
    ...
    gridAgency.jqGrid.AddColumn("Status", "资料认证状态", true, null, 50,
        function (obj, options, rowObject) {
            if (obj == '0')
                return "申请认证";
            else if (obj == '1')
    ...
    gridAgency.jqGrid.AddColumn("RealNameStatus", "实名认证状态", true, null, 50,
        function (obj, options, rowObject) {
            if (obj == '0')
                return "未认证";
            else if (obj == '1')
