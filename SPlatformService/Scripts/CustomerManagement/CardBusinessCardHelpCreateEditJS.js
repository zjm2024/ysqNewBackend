$(document).ready(function () {
    ...
    $("#btn_save").click(function () {
        ...
        $.ajax({
            url: "https://www.zhongxiaole.net/BusinessCard/SPWebAPI/BusinessCard/AddBusinessCardHelp?token=" + _Token,
            type: "POST",
...
function Init() {
    ...
    if (HelpID > 0) {
        ...
        load_show();
        $.ajax({
            url: "https://www.zhongxiaole.net/BusinessCard/SPWebAPI/BusinessCard/GetBusinessCardHelp?HelpID=" + HelpID,
            type: "Get",
            data: null,
            success: function (data) {
                console.log(data);
