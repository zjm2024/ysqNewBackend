<%@ Page Language="C#" MasterPageFile="~/Shared/MasterPage.Master" AutoEventWireup="true" CodeBehind="RequirementBrowse.aspx.cs" Inherits="SPlatformService.RequireManagement.RequirementBrowse" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Content" runat="server">    
    <script type="text/javascript" src="../Scripts/RequireManagement/RequirementBrowseJS.js"></script>
                ...
                <div class="form-group" style="margin-top: 10px;">   
                    ...
                    <div class="col-sm-2">
                        <asp:DropDownList ID="drpStatus" runat="server" CssClass="col-xs-12 col-sm-12">
                            ...
                            <asp:ListItem Text="暂停投简历" Value="3"></asp:ListItem>
                            <asp:ListItem Text="已创建项目" Value="4"></asp:ListItem>
                            <asp:ListItem Text="审核中" Value="5"></asp:ListItem>
                        </asp:DropDownList>
                    </div>                     
