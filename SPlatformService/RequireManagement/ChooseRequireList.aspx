<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChooseRequireList.aspx.cs" Inherits="SPlatformService.RequireManagement.ChooseRequireList" %>
                        ...
                        <div class="col-xs-12">
                            <div class="form-horizontal">
                                <div class="form-group" style="margin-top: 10px;">
                                    <label class="col-xs-2 col-sm-2 control-label no-padding-right">区域</label>
                                    <div class="col-sm-2">
                                    ...
                                    <label class="col-xs-2 col-sm-2 control-label no-padding-right">行业类型</label>
                                    <div class="col-sm-2">
