<%@ Page Language="C#" MasterPageFile="~/Shared/MasterPage.Master" AutoEventWireup="true" CodeBehind="AgencyBrowse.aspx.cs" Inherits="SPlatformService.CustomerManagement.AgencyBrowse" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Content" runat="server">    
    <script type="text/javascript" src="../Scripts/CustomerManagement/AgencyBrowseJS.js"></script>
    <div class="search-condition">        
        <table class="wtright" style="height: 100%; float: left;">
            <tr>               
                <td>
                    <button class="wtbtn yjright" type="button" id="btn_delete" onclick="return UpdateAgencyStatus(2,'B');" title="取消资料认证">
                        <i class="icon-ok bigger-110"></i>
                        取消实名认证
                    </button>
                </td>
                <td>
                    <button class="wtbtn yjright" type="button" id="btn_disable" onclick="return UpdateAgencyStatus(1,'B');" title="通过实名认证">
                        <i class="icon-ok bigger-110"></i>
                        通过实名认证
                    </button>                   
                </td>
                <td>
                    <button class="wtbtn yjright" type="button" id="btn_delete" onclick="return UpdateAgencyStatus(2,'A');" title="取消资料认证">
                        <i class="icon-ok bigger-110"></i>
                        取消资料认证
                    </button>
                </td>
                <td>
                    <button class="wtbtn yjright" type="button" id="btn_disable" onclick="return UpdateAgencyStatus(1,'A');" title="通过资料认证">
                        <i class="icon-ok bigger-110"></i>
                        通过资料认证
                    </button>                   
                </td>
