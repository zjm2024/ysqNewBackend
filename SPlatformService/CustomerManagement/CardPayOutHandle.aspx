<%@ Page Title="" Language="C#" MasterPageFile="~/Shared/MasterPage.Master" AutoEventWireup="true" CodeBehind="CardPayOutHandle.aspx.cs" Inherits="SPlatformService.CustomerManagement.CardPayOutHandle" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Content" runat="server">

    <script type="text/javascript" src="../Scripts/CustomerManagement/CardPayOutHandleJS.js"></script>
     <div class="form-group">
        <label class="col-sm-2 control-label no-padding-right ">申请类型 </label>

        <div class="col-sm-9">
            <asp:textbox id="textType"  readonly="true" runat="server" cssclass="col-xs-10 col-sm-5" maxlength="20"></asp:textbox>
            <%if (!isLegitimate){%>
                    <div style="color:red;line-height:31px; padding-left:20px">
                       账户余额异常，请谨慎转账提现
                    </div>
                    <%} %>
        </div>
    ...
    <div class="clearfix form-actions">
        <div class="col-sm-5" style="width: 700px; text-align: center; margin-top:20px;">
            ...
            <button class="wtbtn" type="button" id="btn_Revenue" runat="server" title="查看收入明细" style="padding: 10px 30px 30px 30px;font-size: 14px;">
                查看收入明细
            </button>
        </div>
    </div>
