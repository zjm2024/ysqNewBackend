<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CardIMG.aspx.cs" Inherits="SPlatformService.CustomerManagement.CardIMG" %>
<!DOCTYPE html>
            ...
            <div class="PartyPosterView">
                    ...
                    <div class="b">
                        <div class="Profiles">
                            <div class="CardData">
                                ...
                                <div class="Headimg" style="background-image:url(<%=CardDataVO.Headimg %>)"></div>
                                <div class="Name"><%=CardDataVO.Name %></div>
                            </div>
                        ...
                        <ul class="info">
                            ...
                            <%if (CardDataVO!=null&&CardDataVO.isDisplayPhone==1&&PartyViewVO.isDisplayContacts==1){%><li class="_Phone"><div class="left Phone"></div><div class="right"><%=CardDataVO.Phone %>(<%=CardDataVO.Name %>)</div></li><%}%>
                        ...
                        <%if (CardDataVO.CorporateName != ""&&PartyID_index == 27){%>
                            <div class="CorporateName">
                                <%=CardDataVO.CorporateName %>
                            </div>
                        <%}%>  
                ...
                <%} else{%>
                    <ul class="info">
                        ...
                        <%if (CardDataVO!=null&&CardDataVO.isDisplayPhone==1&&PartyViewVO.isDisplayContacts==1){%><li><div class="left">联系方式：</div><div class="right"><%=CardDataVO.Phone %>(<%=CardDataVO.Name %>)</div></li><%}%>
                ...
                { %>
                    <ul class="info">
                        <li><div class="left">发起人：</div><div class="right"><%=CardDataVO.Name %></div></li>
                ...
                <%} %>
                <%}else{ %>
                    <%if (CardPartyCostVO.Count > 0){ %>
                        <div class="MainImg" style="background-image:url(<%=CardPartyCostVO[0].Image%>)"></div>
                    <%}else{ %>
                        <div class="MainImg" style="background-image:url(http://www.zhongxiaole.net/SPManager/Style/images/wxcard/PartyImg/12.jpg)"></div>
                    <%} %>
                    <%if (PartyViewVO.QRCodeImg != ""){%>
                    ...
                    <div class="info">
                        <div class="CostList">
                            <%for(int i=0;i<CardPartyCostVO.Count&&i<3;i++){ %>
                            <div class="li">
                               <%=CardPartyCostVO[i].Names %>：<%=CardPartyCostVO[i].Content %>*<%=CardPartyCostVO[i].limitPeopleNum %>份
                            </div>
                            <%} %>
                            <%if(CardPartyCostVO.Count>3){ %>
                            <div class="li">
                               ⵈ
                            </div>
                            <%} %>
