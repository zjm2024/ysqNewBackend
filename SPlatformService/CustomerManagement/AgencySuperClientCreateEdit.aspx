<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgencySuperClientCreateEdit.aspx.cs" Inherits="SPlatformService.CustomerManagement.AgencySuperClientCreateEdit" %>
                        ...
                        <div class="col-xs-12">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <%--<div class="col-sm-9">--%>
                                    <asp:TextBox ID="txtSuperClientName" runat="server" CssClass="col-sm-9"></asp:TextBox>
                                    <%--</div>--%>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtCompanyName" runat="server" CssClass="col-sm-9"></asp:TextBox>

                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label no-padding-right need">具体优势（比如曾跟踪某个项目虽然跟丢但是跟决策人很熟） </label>
                                </div>
                                <div class="form-group">

                                    <asp:TextBox ID="txtDescription" CssClass="col-sm-9" runat="server" Style="height: 200px; width: 450px; border: 1px solid #d7d3d3; background-color: #fff; padding-left: 10px; font-size: 12px;" TextMode="MultiLine"></asp:TextBox>
