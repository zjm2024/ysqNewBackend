<%@ Page Language="C#" MasterPageFile="~/Shared/MasterPage.Master" AutoEventWireup="true" CodeBehind="CardBusinessCardBrowse.aspx.cs" Inherits="SPlatformService.CustomerManagement.CardBusinessCardBrowse" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Content" runat="server">    
    <script type="text/javascript" src="../Scripts/CustomerManagement/CardBusinessCardBrowseJS.js"></script>
