<%@ Page Language="C#" MasterPageFile="~/Shared/MasterPage.Master" AutoEventWireup="true" CodeBehind="CardBusinessCardOrderBrowse.aspx.cs" Inherits="SPlatformService.CustomerManagement.CardBusinessCardOrderBrowse" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Content" runat="server">    
    <script type="text/javascript" src="../Scripts/CustomerManagement/CardBusinessCardOrderBrowseJS.js"></script>
