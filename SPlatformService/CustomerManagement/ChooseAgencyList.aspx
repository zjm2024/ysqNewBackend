<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChooseAgencyList.aspx.cs" Inherits="SPlatformService.CustomerManagement.ChooseAgencyList" %>
...
<head runat="server">
    ...
    <script src="<%= ResolveUrl("~/Scripts/CustomerManagement/ChooseAgencyListJS.js")%>" type="text/javascript"></script>
</head>
<body class="no-skin">
                ...
                <div class="page-content" style="height:350px;">
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="col-xs-12" id="frame" style="width: 100%; height: 100%; padding: 0px 0px 0px 0px;">
                            <table id="ChooseAgencyList" width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-striped table-bordered table-hover dataTable"></table>
                            <div id="ChooseAgencyListDiv"></div>
                        </div>
                    </div>
