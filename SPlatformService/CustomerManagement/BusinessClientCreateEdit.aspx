<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BusinessClientCreateEdit.aspx.cs" Inherits="SPlatformService.CustomerManagement.BusinessClientCreateEdit" %>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label no-padding-right need">详情 </label>
                                </div>
                                <div class="form-group">
