<%@ Page Language="C#" MasterPageFile="~/Shared/MasterPage.Master" AutoEventWireup="true" CodeBehind="CardDiscountCodeBrowse.aspx.cs" Inherits="SPlatformService.CustomerManagement.CardDiscountCodeBrowse" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Content" runat="server">    
    <script type="text/javascript" src="../Scripts/CustomerManagement/CardDiscountCodeBrowseJS.js"></script>
