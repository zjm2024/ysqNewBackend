<%@ Page Language="C#" MasterPageFile="~/Shared/MasterPage.Master" AutoEventWireup="true" CodeBehind="CardHelpCreateEdit.aspx.cs" Inherits="SPlatformService.UserManagement.CardHelpCreateEdit" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Content" runat="server">
    <script type="text/javascript" src="../Scripts/CustomerManagement/CardHelpCreateEditJS.js"></script>
        ...
        <div class="col-xs-12">
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <asp:DropDownList ID="Type" runat="server" CssClass="col-xs-10 col-sm-2">
                            <asp:ListItem Text="名片功能" Value="1"></asp:ListItem>
                            <asp:ListItem Text="活动功能" Value="2"></asp:ListItem>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <asp:TextBox ID="Order_Num" runat="server" CssClass="col-xs-10 col-sm-5"></asp:TextBox>
                    </div>
                </div>
