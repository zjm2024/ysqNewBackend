<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChangeUserPassword.aspx.cs" Inherits="SPlatformService.UserManagement.ChangeUserPassword" %>
...
<head runat="server">
    ...
    <script src="<%= ResolveUrl("~/Scripts/UserManagement/ChangeUserPasswordJS.js")%>" type="text/javascript"></script>
                        ...
                        <div class="col-xs-12">
                            <div class="form-horizontal">                                
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <asp:TextBox ID="txtPassword" runat="server" CssClass="col-xs-9 col-sm-5" TextMode="Password"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-5">
                                        <asp:TextBox ID="txtPasswordConfirm" runat="server" CssClass="col-xs-9 col-sm-5" TextMode="Password"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
