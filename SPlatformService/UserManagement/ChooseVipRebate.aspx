<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChooseVipRebate.aspx.cs" Inherits="SPlatformService.UserManagement.ChooseVipRebate" %>
        ...
        <div class="main-container" id="main-container">
            <div class="main-content">
                <div class="page-content" style="height:200px;">
                    <div class="search-condition" style="height: 182px;">
                        <div class="col-xs-12">
                            <div class="form-horizontal">
                                <div class="form-group" style="margin-top: 10px;">
                                    <style>
                                        .form-group .inputcss{width: 100%;
                                        height: 45px;
                                        margin-top: 54px;
                                    ...
                                    <div class="col-sm-3">
                                        <asp:TextBox ID="txtCustomerId" runat="server" CssClass="col-xs-3 col-sm-3 inputcss" MaxLength="30" placeholder="请输入会员ID"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
