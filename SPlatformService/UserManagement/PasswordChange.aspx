<%@ Page Language="C#" MasterPageFile="~/Shared/MasterPage.Master" AutoEventWireup="true" CodeBehind="PasswordChange.aspx.cs" Inherits="SPlatformService.UserManagement.PasswordChange" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Content" runat="server">
    <script type="text/javascript" src="../Scripts/UserManagement/PasswordChangeJS.js"></script>
    <div class="row">
        <div class="col-xs-12">
