<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChooseUserList.aspx.cs" Inherits="SPlatformService.UserManagement.ChooseUserList" %>
...
<head runat="server">
    ...
    <script src="<%= ResolveUrl("~/Scripts/UserManagement/ChooseUserListJS.js")%>" type="text/javascript"></script>
</head>
<body class="no-skin">
                ...
                <div class="page-content" style="height:350px;">
                        ...
                        <div class="col-xs-12">
                            <div class="form-horizontal">
                                <div class="form-group" style="margin-top: 10px;">
                                    <label class="col-xs-1 col-sm-1 control-label no-padding-right">部门&nbsp;&nbsp;</label>
                                    <div class="col-sm-2">
                                        <asp:DropDownList ID="drpDepartment" runat="server" CssClass="col-xs-2 col-sm-2">
                                            <asp:ListItem Text="--选择--" Value="-1" Selected="True"></asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                    <label class="col-xs-2 col-sm-2 control-label no-padding-right">员工姓名&nbsp;&nbsp;</label>
                                    <div class="col-sm-3">
                                        <asp:TextBox ID="txtUserName" runat="server" CssClass="col-xs-3 col-sm-3" MaxLength="30"></asp:TextBox>
                                    </div>
                                    <div>
                                        &nbsp;&nbsp;&nbsp;&nbsp;
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="col-xs-12" id="frame" style="width: 100%; height: 100%; padding: 0px 0px 0px 0px;">
                            <table id="ChooseUserList" width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-striped table-bordered table-hover dataTable"></table>
                            <div id="ChooseUserListDiv"></div>
                        </div>
                    </div>
