<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChooseRecharge.aspx.cs" Inherits="SPlatformService.UserManagement.ChooseRecharge" %>
                        ...
                        <div class="col-xs-12">
                            <div class="form-horizontal">
                                <div class="form-group" style="margin-top: 10px;">
                                    ...
                                    <div class="col-sm-3">
                                        <asp:TextBox ID="txtCost" runat="server" CssClass="col-xs-3 col-sm-3 inputcss" MaxLength="30" placeholder="请输入数额"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                        </div>
