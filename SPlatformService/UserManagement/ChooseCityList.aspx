<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChooseCityList.aspx.cs" Inherits="SPlatformService.UserManagement.ChooseCityList" %>
                        ...
                        <div class="col-xs-12">
                            <div class="form-horizontal">
                                <div class="form-group" style="margin-top: 10px;">
                                    ...
                                    <div class="col-sm-2">
                                        <asp:DropDownList ID="drpProvince" runat="server" CssClass="col-xs-2 col-sm-2">
                                    ...
                                    <div class="col-sm-3">
                                        <asp:TextBox ID="txtCityName" runat="server" CssClass="col-xs-3 col-sm-3" MaxLength="30"></asp:TextBox>
                                    </div>
                                    <div>
