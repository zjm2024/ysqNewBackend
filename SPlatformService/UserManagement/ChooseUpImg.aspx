<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChooseUpImg.aspx.cs" Inherits="SPlatformService.UserManagement.ChooseUpImg" %>
        ...
        <div class="main-container" id="main-container">
            <div class="main-content">
                <div class="page-content" style="height:400px;">
                    <div class="search-condition" style="height: 385px;">
                        <div class="col-xs-12">
                            <div class="form-horizontal">
                                <div class="form-group" style="margin-top: 10px;">
                                    <style>
                                        .form-group .Uploadcss{
                                        height: 45px;
                                        line-height:45px;
                                        border:none;
                                        margin-top: 78px;
                                        ...
                                        .form-group .DropDowncss{width: 50%;
                                        height: 45px;
                                        line-height:45px;
                                        margin-top: 10px;
                                        font-size: 16px;}
                                    ...
                                    <div class="col-sm-3">
                                        <asp:FileUpload ID="MyFileUpload" runat="server" AllowMultiple="true" CssClass="Uploadcss"/>
                                        <asp:DropDownList ID="DropDownList1" runat="server" CssClass="DropDowncss"></asp:DropDownList>
                                        <asp:DropDownList ID="DropDownList2" runat="server" CssClass="DropDowncss"></asp:DropDownList>
                                         <asp:Button ID="Button1" runat="server" Text="添加文件" OnClick="FileUploadButton_Click" CssClass="btn"/>
                                    </div>
                                </div>
                            </div>
                        </div>
