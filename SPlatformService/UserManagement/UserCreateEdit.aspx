<%@ Page Language="C#" MasterPageFile="~/Shared/MasterPage.Master" AutoEventWireup="true" CodeBehind="UserCreateEdit.aspx.cs" Inherits="SPlatformService.UserManagement.UserCreateEdit" %>


<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Content" runat="server">
    <script type="text/javascript" src="../Scripts/UserManagement/UserCreateEditJS.js"></script>
    <div class="row">
        <div class="col-xs-12">
            <div class="form-horizontal">
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <asp:DropDownList ID="drpDepartment" runat="server" CssClass="col-xs-10 col-sm-5">
                ...
                <%--<div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <asp:DropDownList ID="drpRole" runat="server" CssClass="col-xs-10 col-sm-5">
                            <asp:ListItem Text="--选择--" Value="-1" Selected="True"></asp:ListItem>
                        </asp:DropDownList>
                    </div>
                </div>--%>
                <div class="form-group" style="margin-top: 10px;">
                    ...
                    <div class="col-sm-1" style="margin-top: 30px;">
                        <button class="wtbtnsearch col-sm-12" type="submit" id="btn_AddRole" title="添加" onclick="return OnAddList('listRole','listRoleSelected','hidSelectedRole');">
                            添加
                        </button>
                        <br />
                        <br />
                        <button class="wtbtnsearch col-sm-12" type="submit" id="btn_RemoveRole" title="移除" onclick="return OnRemoveList('listRole','listRoleSelected','hidSelectedRole');">
                            移除
                        </button>
                    </div>
                    <div class="col-sm-3">
                ...
                <div class="form-group" style="display: none;">
                    <label class="col-sm-2 control-label no-padding-right need">密码 </label>
                ...
                <div class="clearfix form-actions">
                    <div class="col-sm-5" style="width: 700px; text-align: center;">
                        ...
                        <button class="wtbtn savebtn" type="button" id="btn_updatepassword" title="修改密码" onclick="return ChangePassword();" style="display: none;">
                            修改密码
                        </button>
    ...
    <asp:HiddenField ID="hidIsUpdatePassword" runat="server" />
</asp:Content>
