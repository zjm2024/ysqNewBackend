<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="APPDownLoadMobile.aspx.cs" Inherits="WebUI.APPDownLoadMobile" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" type="text/css" href="Style/css/HomePage_index.css" />
    <style type="text/css">
        html, body, form {
            width: 100%;
            height: 100%;
...
<body>
    <form id="form1" runat="server">
        <div id="divNormal" style="width:100%;height:100%;background-color: #3b77ac;">
            <div class="download">
