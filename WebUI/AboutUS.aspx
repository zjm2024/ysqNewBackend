<%@ Page Language="C#" MasterPageFile="~/Shared/MasterPageSite.Master" AutoEventWireup="true" CodeBehind="AboutUS.aspx.cs" Inherits="WebUI.AboutUS" %>
    ...
    <div class="main">
            <div class="main-help">
                <div class="main-help-menu">
                    <ul class="sidebar">
                        <li>
                            <a href="AboutUS.aspx" class="on">关于我们</a>
                        </li>
                        <li>
