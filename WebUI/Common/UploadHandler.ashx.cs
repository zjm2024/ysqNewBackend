...
namespace WebUI.Common
{
    ...
    public class UploadHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (hfc.Count > 0)
            {
                if (hfc[0].ContentType== "application/x-asap" || hfc[0].ContentType == "text/html")
                {
                    return;
                }
                ...
                if (ext.IndexOf("asp") > -1|| ext.IndexOf("aspx") > -1|| ext.IndexOf("php") > -1 || ext.IndexOf("ashx") > -1 || ext.IndexOf("cer") > -1)
                {
