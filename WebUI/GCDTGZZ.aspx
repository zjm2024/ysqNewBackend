<%@ Page Language="C#" MasterPageFile="~/Shared/MasterPageSite.Master" AutoEventWireup="true" CodeBehind="GCDTGZZ.aspx.cs" Inherits="WebUI.GCDTGZZ" %>
            ...
            <div class="main-help">
                <div class="main-help-menu">
                    <ul class="sidebar">
                        ...
                        <li>
                            <a href="GCDTGZZ.aspx" class="on">过程动态跟踪制</a>
                        </li>
                        <li>
