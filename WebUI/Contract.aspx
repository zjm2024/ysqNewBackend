<%@ Page Language="C#" MasterPageFile="~/Shared/MasterPageSite.Master" AutoEventWireup="true" CodeBehind="Contract.aspx.cs" Inherits="WebUI.Contract" %>
            ...
            <div class="main-help">
                <div class="main-help-menu">
                    <ul class="sidebar">
                        ...
                        <li>
                            <a href="Contract.aspx" class="on">联系我们</a>
                        </li>
                        <li>
