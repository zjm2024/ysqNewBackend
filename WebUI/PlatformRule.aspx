<%@ Page Language="C#" MasterPageFile="~/Shared/MasterPageSite.Master" AutoEventWireup="true" CodeBehind="PlatformRule.aspx.cs" Inherits="WebUI.PlatformRule" %>
            ...
            <div class="main-help">
                <div class="main-help-menu">
                    <ul class="sidebar">
                        ...
                        <li>
                            <a href="PlatformRule.aspx" class="on">众销乐规则</a>
                        </li>
                         <li>
                ...
                <div class="help-main">
                    <div class="help-hd">
                        <h2 class="help-tit">众销乐规则</h2>
                    </div>
                    <div class="help-bd" id="divNote"  style="font-size: 18px;" runat="server">
