<%@ Page Language="C#" MasterPageFile="~/Shared/MasterPage.Master" AutoEventWireup="true" CodeBehind="BusinessProjectCreateEdit.aspx.cs" Inherits="WebUI.ProjectManagement.BusinessProjectCreateEdit" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Content" runat="server">
    <script type="text/javascript" src="../Scripts/ProjectManagement/BusinessProjectCreateEditJS.js"></script>
                    ...
                    <div class="tab-content">
                        <div id="home4" class="tab-pane active">
                            ...
                            <div class="form-group" id="divpercentage" style="display: none">
                                ...
                                <div class="col-sm-9">
                                    <asp:TextBox ID="txtpercentage" runat="server" CssClass="col-xs-10 col-sm-5"></asp:TextBox>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <asp:TextBox ID="txtCommission" runat="server" CssClass="control-label" Enabled="false" Style=" text-align:left"></asp:TextBox>
                                    <button class="wtbtn wtbtn-create" type="button" id="btn_ChangeCommission" runat="server" title="申请更改总酬金">
                                        申请更改总酬金
                                    </button>
                                    
                                    <div class="newChange" style="display:none">正在申请将总酬金更改为：<asp:Label CssClass="control-label" Style="color:#ff0000" ID="newChange" runat="server" Text="0"></asp:Label>，请提醒销售到项目工作台确认</div>
                                </div>
                            </div>
                            <div id="divCommissionDelegateInfo" style="display: none;">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label no-padding-right">平台抽佣 </label>

                                    <div class="col-sm-9">
                                        <asp:Label CssClass="control-label" Style="line-height: 30px;" ID="lblPlatformCommission" runat="server" Text="0"></asp:Label>
                                    </div>
                                </div>
                                <div class="form-group" style="display:none">
                                    <label class="col-sm-2 control-label no-padding-right">委托总金额 </label>

                                    <div class="col-sm-9">
                                        <asp:Label CssClass="control-label" Style="line-height: 30px;" ID="lblTotalCommission" runat="server" Text="0"></asp:Label>
                                    </div>
                                </div>
                                <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right need">已托管酬金 </label>

                                <div class="col-sm-9">
                                    <asp:Label CssClass="control-label" Style="line-height: 30px;" ID="lblDelegationCommission" runat="server" Text="0"></asp:Label>
                                    <button class="wtbtn wtbtn-create" type="button" id="btn_plusdelegationcommission" runat="server" title="追加托管">
                                        追加托管
                                    </button>
                                    <button class="wtbtn" type="button" id="btn_canceldelegationcommission" runat="server" title="取消托管并关闭本项目">
                                        取消托管并关闭本项目
                                    </button>
                                    <div class="ProjectRefund" style="display:none;"></div>
                                </div>
                            </div>
                            ...
                            <div id="divCommissionDelegate" style="display: none;">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <asp:TextBox ID="txtPlatformCommission" runat="server" CssClass="col-xs-10 col-sm-5" Enabled="false"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label no-padding-right">委托总金额 </label>
                                    ...
                                    <div class="col-sm-9">
                                        <asp:TextBox ID="txtTotalCommission" runat="server" CssClass="col-xs-10 col-sm-5" Enabled="false"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <div id="divWorking" style="margin-left: 10px; margin-right: 10px; display: none;">
                                ...
                                <div id="divProjectCommissionInfo">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <asp:TextBox ID="txtRejectReason" runat="server" CssClass="description-textarea" TextMode="MultiLine"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div id="divWorkEnd" style="display: none; margin-left: 10px; margin-right: 10px;">
                                <%--评价阶段。双方评价对方。双方申请维权--%>
                                <div id="divReviewAgency">
                                    <div class="form-group">
                                        <h4 class="header">对销售评价</h4>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div id="divReviewBusiness" style="display: none;">
                                    <div class="form-group">
                                        <h4 class="header">销售对您的评价</h4>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="xzw_starSys">
                                                <div class="xzw_starBox">
                                                    <ul class="star stars" disabled="disabled">
                                                        <li><a href="javascript:void(0)" title="1" class="one-star">1</a></li>
                                                        <li><a href="javascript:void(0)" title="2" class="two-stars">2</a></li>
                                                        <li><a href="javascript:void(0)" title="3" class="three-stars">3</a></li>
                                                        <li><a href="javascript:void(0)" title="4" class="four-stars">4</a></li>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right">评价内容</label>
                                        <div class="col-sm-9">
                                            <div id="divAgecnyReviewDescription" style="padding-top: 6px; margin-left: 10px;"></div>
                                        </div>
                                    </div>
                                    <div class="form-group" id="divAgencyAddNote">
                                        <label class="col-sm-2 control-label no-padding-right">追评内容</label>
                                        <div class="col-sm-9">
                                            <div id="divAgecnyReviewAddNote" style="padding-top: 6px; margin-left: 10px;"></div>
                                        </div>
                                    </div>
                                    <div class="form-group" id="divExplanation">
                                        <label class="col-sm-2 control-label no-padding-right">回复内容</label>
                                        <div class="col-sm-9">
                                            <asp:TextBox ID="txtExplanationDescription" runat="server" CssClass="description-textarea" TextMode="MultiLine"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-2 control-label no-padding-right"></label>
                                        <div class="col-sm-9">
                                            <button class="wtbtn yjright" type="button" id="btn_ExplanReview" onclick="return ExplanReview();" title="回复">
                                                <i class="icon-ok bigger-110"></i>
                                                回复
                                            </button>
                                        </div>
                        ...
                        <div id="report" class="tab-pane">
                            <%--           <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right">上传报表类型 </label>
                                <div class="col-sm-9">
                                    <asp:DropDownList ID="ddlreportType" runat="server" CssClass="col-xs-10 col-sm-2" Enabled="false">
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right">报表描述 </label>
                                <div class="col-sm-9">
                                    <asp:TextBox ID="txtReportDesc" runat="server" Style="height: 100px; width: 350px; border: 1px solid #d7d3d3; background-color: #fff; padding-left: 10px; font-size: 12px; margin-top: 4px;" TextMode="MultiLine"></asp:TextBox>
                                </div>
                            </div>--%>
                            <div class="form-group">
                                <label class="col-sm-2 control-label no-padding-right"></label>
