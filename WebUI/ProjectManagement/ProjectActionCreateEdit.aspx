<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectActionCreateEdit.aspx.cs" Inherits="WebUI.ProjectManagement.ProjectActionCreateEdit" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $(".ace-file-input").attr("style", "width: 41.6666%;float:left;");
        ...
        function changefile(uploadId) {
            ...
            uploadFile(uploadId, tempPath, function (data) {
                if (data.Flag == 1) {
                    ...
                    projectActionFileVO.ProjectActionId = -1;
                    projectActionFileVO.FileName = data.Result.FileName;
                    projectActionFileVO.FilePath = data.Result.FilePath.replace("~", _APIURL);
                    AddFile(projectActionFileVO);
                    load_hide();
                } else {
                    bootbox.dialog({
        ...
        function AddFile(puVO) {
            ...
            oTR += "    <input type=\"hidden\" value=\"File_" + puVO.ProjectActionId + "_" + puVO.ProjectActionFileId + "\" /> \r\n";
            oTR += "  </td> \r\n";
                        ...
                        <div class="col-xs-12">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <label class="col-sm-2 control-label no-padding-right need">跟进内容 </label>
