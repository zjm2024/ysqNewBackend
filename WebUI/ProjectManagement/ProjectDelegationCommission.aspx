<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectDelegationCommission.aspx.cs" Inherits="WebUI.ProjectManagement.ProjectDelegationCommission" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="../Scripts/ProjectManagement/ProjectDelegationCommissionJS.js"></script> 
</head>
<body class="no-skin">
    <form id="form1" runat="server">
        <div class="main-container" id="main-container">
            <div class="main-content">
                <div class="page-content" style="height: 160px;">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <label class="col-xs-3 control-label no-padding-right">酬金 </label>

                                    <div class="col-xs-9">
                                        <label class="col-xs-2 control-label" id="lblProjectCommission"></label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-xs-3 control-label no-padding-right">任务已委托酬金 </label>

                                    <div class="col-xs-9">
                                        <label class="col-xs-2 control-label" id="lblDelegateRequireCommission"></label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-xs-3 control-label no-padding-right">项目已委托酬金 </label>

                                    <div class="col-xs-9">
                                        <label class="col-xs-2 control-label" id="lblDelegateProjectCommission"></label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-xs-3 control-label no-padding-right need">委托金额 </label>
