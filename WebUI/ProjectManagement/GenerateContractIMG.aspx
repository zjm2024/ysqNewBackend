<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GenerateContractIMG.aspx.cs" Inherits="WebUI.ProjectManagement.GenerateContractIMG" %>
...
<body class="no-skin" style="background-color: #FFF;" id="index">
    <form id="form1" runat="server">
        <style>.page-content{ background:none}</style>
    <div class="lg_Generate lg_Generate_IMG">
        <div class="lg_Generate_left">
             ...
             <div class="G_JieDuan">
                  ...
                  <div id="G_JieDuan_list" runat="server">
