<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectChangeCommission.aspx.cs" Inherits="WebUI.ProjectManagement.ProjectChangeCommission" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="../Scripts/ProjectManagement/ProjectChangeCommissionJS.js"></script>
</head>
<body class="no-skin">
    <form id="form1" runat="server">
        <div class="main-container" id="main-container">
            <div class="main-content">
                <div class="page-content" style="height: 250px;">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    <label class="col-xs-2 control-label no-padding-right">当前总酬金 </label>
                                ...
                                <div class="form-group">
                                    <label class="col-xs-2 control-label no-padding-right">已支付酬金 </label>

                                    <div class="col-xs-9">
                                        <label class="col-xs-2 control-label no-padding-right" id="lblpayoutCommission"></label>
                                    </div>
                                </div>
                                <div class="form-group">
