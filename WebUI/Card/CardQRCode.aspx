<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CardQRCode.aspx.cs" Inherits="WebUI.Card.CardQRCode" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script>
       ...
       var dataForWeixin = {
                    ...
                    title: '<%=CardDataVO.Name%>',
                    <%if (CardDataVO.Headimg != ""){%>
    	            imgUrl: '<%=CardDataVO.Headimg%>',
                    <%}else {%>
...
<body class="partyBody">
    ...
    <div class="QRCode">
        ...
        <div class="t2">步骤二</div>
        <div class="t1">识别之后选择前往小程序<font>“乐聊名片”</font>，查看名片吧！</div>
    </div>
    <%} %>
    </form>
</body>
