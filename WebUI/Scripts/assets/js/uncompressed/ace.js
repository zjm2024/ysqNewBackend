...
ace.handle_side_menu = function($) {
	...
	.on(ace.click_event + '.ace.menu', '.sidebar-collapse', function () {
	    var overset = $('#sidebar')[0];
	    if (overset.style.overflowY == 'auto') {
	        $('#sidebar')[0].style.overflowY = '';
	        $("#leftMiddle").addClass("leftsmall");
	    }
	    else
	    {
	        $('#sidebar')[0].style.overflowY = 'auto';
	        $("#leftMiddle").removeClass("leftsmall");
	    }
