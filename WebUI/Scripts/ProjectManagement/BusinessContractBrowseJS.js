...
var grid = new JGrid();
function onPageInit() {
    grid.jqGrid.ID = "BusinessContractList";
    grid.jqGrid.PagerID = "BusinessContractListDiv";
    grid.jqGrid.Source = "../Common/GetDataJsonGrid.ashx";
    grid.jqGrid.Params = "table=BusinessContractList&BusinessCustomerId=" + _CustomerId;
    ...
    grid.jqGrid.AddColumn("CompanyName", "雇主", true, null, 60);
    grid.jqGrid.AddColumn("AgencyName", "销售", true, null, 60);
    ...
    grid.jqGrid.AddColumn("ContractId", "合同附件", true, null, 80,
        function (obj, options, rowObject) {
            var contractId = obj;
            var oTR = "";
            //绑定附件
