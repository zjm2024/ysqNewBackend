...
var grid = new JGrid();
function onPageInit() {
    grid.jqGrid.ID = "AgencyProjectList";
    grid.jqGrid.PagerID = "AgencyProjectListDiv";
    grid.jqGrid.Source = "../Common/GetDataJsonGrid.ashx";
    grid.jqGrid.Params = "table=AgencyProjectList&AgencyCustomerId=" + _CustomerId;
...
function EditProject(projectObj) {
    window.location.href = "AgencyProjectCreateEdit.aspx?ProjectId=" + $(projectObj).prev().val();
    return false;
}
