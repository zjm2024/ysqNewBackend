<%@ Page Language="C#" MasterPageFile="~/Shared/MasterPageSite.Master" AutoEventWireup="true" CodeBehind="WXLoginPage.aspx.cs" Inherits="WebUI.ThirdLogin.WXLoginPage" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Content" runat="server">
    <script type="text/javascript" src="../Scripts/CustomerManagement/WXLogin.js"></script>
                                        ...
                                        <fieldset>
                                            <label class="block clearfix">
                                                <span class="block input-icon input-icon-right">
                                                    ...
                                                    <asp:TextBox ID="txtPhone" class="form-control" placeholder="手机号码" runat="server" />
