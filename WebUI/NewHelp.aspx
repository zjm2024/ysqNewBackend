<%@ Page Language="C#" MasterPageFile="~/Shared/MasterPageSite.Master" AutoEventWireup="true" CodeBehind="NewHelp.aspx.cs" Inherits="WebUI.NewHelp" %>
                ...
                <div class="main-help-menu">
                    <ul class="sidebar">
                       <li>
                        ...
                        <li>
                            <a href="NewHelp.aspx" class="on">新手指南</a>
                        </li>
                        <li>
