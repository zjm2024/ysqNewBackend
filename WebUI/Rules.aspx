<%@ Page Language="C#" MasterPageFile="~/Shared/MasterPageSite.Master" AutoEventWireup="true" CodeBehind="Rules.aspx.cs" Inherits="WebUI.Rules" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Content" runat="server">
    <div class="main">
            <div class="main-help">
                ...
                <div class="help-main">
                    <div class="help-hd">
                        <h2 class="help-tit" id="ruleTitle" runat="server"></h2>
                    </div>
