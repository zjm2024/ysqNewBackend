<%@ Page Language="C#" MasterPageFile="~/Shared/MasterPageSite.Master" AutoEventWireup="true" CodeBehind="BusinessHZ.aspx.cs" Inherits="WebUI.BusinessHZ" %>
            ...
            <div class="main-help">
                <div class="main-help-menu">
                    <ul class="sidebar">
                        ...
                        <li>
                            <a href="BusinessHZ.aspx" class="on">商务合作</a>
                        </li>
                    </ul>
                </div>
                <div class="help-main">
                    <div class="help-hd">
                        <h2 class="help-tit">商务合作</h2>
                    </div>
