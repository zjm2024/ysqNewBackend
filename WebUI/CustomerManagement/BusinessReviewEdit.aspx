<%@ Page Language="C#" MasterPageFile="~/Shared/MasterPage.Master" AutoEventWireup="true" CodeBehind="BusinessReviewEdit.aspx.cs" Inherits="WebUI.CustomerManagement.BusinessReviewEdit" %>


<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder_Content" runat="server">
    <script type="text/javascript" src="../Scripts/CustomerManagement/BusinessReviewEditJS.js"></script>
        ...
        <div class="col-xs-12">
            <div class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <div id="divAgencyName" style="padding-top: 6px; margin-left: 10px;"></div>
                    </div>
                </div>
                <div class="form-group">
