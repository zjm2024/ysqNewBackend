<%@ Page Language="C#" MasterPageFile="~/Shared/MasterPageSite.Master" AutoEventWireup="true" CodeBehind="ComissionDelegation.aspx.cs" Inherits="WebUI.ComissionDelegation" %>
            ...
            <div class="main-help">
                <div class="main-help-menu">
                    <ul class="sidebar">
                        ...
                        <li>
                            <a href="ComissionDelegation.aspx" class="on">酬金托管制</a>
                        </li>
                        <li>
