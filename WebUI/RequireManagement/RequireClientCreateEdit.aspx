<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RequireClientCreateEdit.aspx.cs" Inherits="WebUI.RequireManagement.RequireClientCreateEdit" %>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label no-padding-right need">用户名称 </label>

                                    <asp:TextBox ID="txtCompanyName" runat="server" CssClass="col-sm-9" placeholder="请填写使用部门"></asp:TextBox>

                                </div>
                                <div class="form-group">
                                    <label class="col-sm-2 control-label no-padding-right need">任务现状 </label>
                                </div>
                                <div class="form-group">
                                    <asp:TextBox ID="txtDescription" CssClass="col-sm-9" placeholder="请填写“初步沟通、立项评估、任务分析、方案制定、招投标、商务谈判”等销售漏斗的六个阶段之一" runat="server" Style="height: 200px; width: 450px; border: 1px solid #d7d3d3; background-color: #fff; padding-left: 10px; font-size: 12px;" TextMode="MultiLine"></asp:TextBox>
                                </div>
                            </div>
                    </div>
                </div>
