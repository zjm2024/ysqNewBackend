...
{
    public partial class RequirementCreateEdit : CustomerBasePage
    {
        public bool dropdown14=false;
        public bool isRealNameStatus{ get; set; }
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (isBusiness && requirementId > 0)
            {
                ...
                BusinessViewVO bVO = bBO.FindBusinessById(requirementVO.BusinessId);
                if (bVO != null)
                {
                    if (bVO.RealNameStatus == 1)
                    {
                        isRealNameStatus = true;
                    }
                    else {
                        isRealNameStatus = false;
                    }
                }
                else {
                    isRealNameStatus = false;
                ...
                btn_plusrequirecommission.Style["display"] = "";
                btn_cancelrequirecommission.Style["display"] = "";
                ...
                List<TenderInviteViewVO> tenderInviteList = SiteCommon.GetRequireTenderInviteByRequire(requirementId);
                ...
                oTR += "    <div class=\"ui-jqgrid-sortable\" title=\"投递日期\">投递日期</div> \r\n";
                oTR += "</th> \r\n";
                oTR += "<th class=\"ui-state-default ui-th-column ui-th-ltr\" style=\"width: 150px; \"> \r\n";
                oTR += "    <div class=\"ui-jqgrid-sortable\" title=\"销售名称\">销售名称</div> \r\n";
                oTR += "</th> \r\n";
                oTR += "<th class=\"ui-state-default ui-th-column ui-th-ltr\" style=\"width: 150px; \"> \r\n";
                ...
                {
                    TenderInviteViewVO tiVO = tenderInviteList[i];
                    oTR += "<tr class=\"ui-widget-content jqgrow ui-row-ltr\"> \r\n";
                    oTR += "  <td class=\"center\"> \r\n";
                    oTR += "    <button class=\"wtbtn yjright\" type=\"button\" onclick=\"return GenerateProject('" + tiVO.CustomerId + "');\" title=\"选中\"> \r\n";
                    oTR += "        <i class=\"icon-ok bigger-110\"></i> \r\n";
                    oTR += "        选中 \r\n";
                    oTR += "    </button> \r\n";
                    oTR += "  </td> \r\n";
                    oTR += "  <td class=\"center\" title=\"" + tiVO.InviteDate.ToString("yyyy-MM-dd hh:ss") + "\">" + tiVO.InviteDate.ToString("yyyy-MM-dd hh:ss") + "</td> \r\n";
                    oTR += "  <td class=\"center\" title=\"" + tiVO.AgencyName + "\"><a href=\"../Agency.aspx?agencyId=" + tiVO.AgencyId + "\" target=\"_blank\" class=\"link\">" + tiVO.AgencyName + "</a></td> \r\n";
