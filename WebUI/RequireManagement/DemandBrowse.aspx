<%@ Page Language="C#" MasterPageFile="~/Shared/MasterPage.Master" AutoEventWireup="true" CodeBehind="DemandBrowse.aspx.cs" Inherits="WebUI.RequireManagement.DemandBrowse" %>
        ...
        <div class="col-xs-12">
            <div class="form-horizontal">
                <div class="form-group" style="margin-top: 10px;">
                    <label class="col-sm-1 control-label no-padding-right">需求状态</label>
                    <div class="col-sm-2">
