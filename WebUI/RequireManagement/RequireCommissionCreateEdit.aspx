<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RequireCommissionCreateEdit.aspx.cs" Inherits="WebUI.RequireManagement.RequireCommissionCreateEdit" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="../Scripts/RequireManagement/RequireCommissionCreateEditJS.js"></script> 
</head>
<body class="no-skin">
    <form id="form1" runat="server">
        <div class="main-container" id="main-container">
            <div class="main-content">
                <div class="page-content" style="height: 150px;">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-9">
                                        <label class="col-xs-2 control-label" id="lblRequireCommission"></label>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-xs-3 control-label no-padding-right">已委托酬金 </label>
