...
function changefile(uploadId) {
    var tempPath = "CustomerFile/" + _CustomerId+"/ContractBox";
    load_show();
...
function BindFile() {
    ...
    $.ajax({
        url: _RootPath + "SPWebAPI/Customer/GetToolFileByCustomer?CustomerId=" + _CustomerId + "&typeId=1&token=" + _Token,
        type: "Get",
        data: null,
        success: function (data) {
            if (data.Flag == 1) {
                ...
                "click":
                {
                    ...
                    "callback": function () {
                        ...
                        for (var i = 0; i < chkList.length; i++) {
                            ...
                            var ToolFileId = chkObj.next().val().split('_')[1];
