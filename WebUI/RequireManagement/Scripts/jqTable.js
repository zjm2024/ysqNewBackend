    ...
    this.jqGrid = {
        ...
        CreateTable: function () {
            ...
            if (this.LengthMenu != null) {
                ...
                Context.rowNum = this.LengthMenu[0];
            }
...
function autoresize(id) {
    ...
    //} else {
        ...
        if (gbox.width() < width) {
            ...
            gbox.parent().width(width);
        } else {
            //gbox.parent().width(gbox.width() + 20);
            gbox.parent().width(gbox.width());
...
function onShowClose() {
    ...
    if (ctrl.style.display == "block") {
        ctrl.style.display = "none";
        $("#showImage").addClass("fa-angle-down");
        $("#showImage").removeClass("fa-angle-up");
        
    }
    else {
        ctrl.style.display = "block";
        $("#showImage").addClass("fa-angle-up fa");
        $("#showImage").removeClass("fa-angle-down");
    }
}
