<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChooseCityList.aspx.cs" Inherits="WebUI.UserManagement.ChooseCityList" %>
...
<head runat="server">
    ...
    <script src="<%= ResolveUrl("~/Scripts/UserManagement/ChooseCityListJS.js")%>" type="text/javascript"></script>
</head>
<body class="no-skin lgcategory">
                ...
                <div class="page-content" style="height:350px;">
                        ...
                        <div class="col-xs-12">
                            <div class="form-horizontal">
                                <div class="form-group" style="margin-top: 10px;">
                                    <label class="col-xs-2 col-sm-2 control-label no-padding-right">省（直辖市）</label>
                                    <div class="col-sm-2">
                                        <asp:DropDownList ID="drpProvince" runat="server" CssClass="col-xs-2 col-sm-2 lgcitytxt">
                                            <asp:ListItem Text="--选择--" Value="-1" Selected="True"></asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                    <label class="col-xs-2 col-sm-2 control-label no-padding-right">城市</label>
                                    <div class="col-sm-3">
                                        <asp:TextBox ID="txtCityName" runat="server" CssClass="col-xs-3 col-sm-3 lgcitytxt" MaxLength="30"></asp:TextBox>
                                    </div>
                                    <div>
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="col-xs-12" id="frame" style="width: 100%; height: 100%; padding: 0px 0px 0px 0px;">
                            <table id="ChooseCityList" width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-striped table-bordered table-hover dataTable"></table>
                            <div id="ChooseCityListDiv"></div>
                        </div>
                    </div>
