<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChooseCategoryList.aspx.cs" Inherits="WebUI.UserManagement.ChooseCategoryList" %>
...
<head runat="server">
    ...
    <script src="<%= ResolveUrl("~/Scripts/UserManagement/ChooseCategoryListJS.js")%>" type="text/javascript"></script>
</head>
                ...
                <div class="page-content" style="height:350px;">
                        ...
                        <div class="col-xs-12">
                            <div class="form-horizontal">
                                <div class="form-group" style="margin-top: 10px;">
                                    ...
                                    <div class="col-sm-2">
                                        <asp:DropDownList ID="drpParentCategory" runat="server" CssClass="col-xs-2 col-sm-2 lgcitytxt">
                                    ...
                                    <div class="col-sm-3">
                                        <asp:TextBox ID="txtCategoryName" runat="server" CssClass="col-xs-3 col-sm-3 lgcitytxt" MaxLength="30"></asp:TextBox>
                                    </div>
                                    <div>
                    ...
                    <div class="form-horizontal">
                        ...
                        <div class="col-xs-12" id="frame" style="width: 100%; height: 100%; padding: 0px 0px 0px 0px;">
                            <table id="ChooseCategoryList" width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-striped table-bordered table-hover dataTable"></table>
                            <div id="ChooseCategoryListDiv"></div>
                        </div>
                    </div>
