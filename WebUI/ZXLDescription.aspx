<%@ Page Language="C#" MasterPageFile="~/Shared/MasterPageSite.Master" AutoEventWireup="true" CodeBehind="ZXLDescription.aspx.cs" Inherits="WebUI.ZXLDescription" %>
                ...
                <div class="main-help-menu">
                    <ul class="sidebar">
                        ...
                        <li>
                         ...
                         <li>
                            <a href="ZXLDescription.aspx" class="on">众销乐介绍</a>
                        </li>
                         <li>
